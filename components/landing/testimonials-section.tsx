...
export function TestimonialsSection() {
    return (
        <section id="testimonials" className="bg-gray-50 dark:bg-gray-950 py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
                <div className="inline-block rounded-lg bg-[#1E3A8A]/10 px-3 py-1 text-sm text-[#1E3A8A] dark:text-blue-600">Testimonials</div>
            ...
            <div className="flex flex-col space-y-4 rounded-lg border bg-white dark:bg-background p-6 shadow-sm">
            ...
            <div className="flex flex-col space-y-4 rounded-lg border bg-white dark:bg-background p-6 shadow-sm">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-muted-foreground">Marketing Associate</p>
                </div>
                </div>
            </div>
            <div className="flex flex-col space-y-4 rounded-lg border bg-white dark:bg-background p-6 shadow-sm">
