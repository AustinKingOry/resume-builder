export function WhyKaziKitSection() {
    return (
        <section id="why-kazikit" className="bg-[#1E3A8A] py-16 md:py-24 text-white">
            <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                <div className="inline-block rounded-lg bg-white/10 px-3 py-1 text-sm text-white">Our Difference</div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Why Choose KaziKit?</h2>
                <p className="mx-auto max-w-[700px] text-white/80 md:text-xl">
                    More than just a resume builder - KaziKit is your complete career toolkit.
                </p>
                </div>
            </div>
