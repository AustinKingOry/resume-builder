    ...
    return (
        <section id="how-it-works" className="bg-white py-16 md:py-24">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl gap-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <h3 className="text-xl font-bold text-[#1E3A8A]">Fill Details</h3>
                <p className="text-gray-600">Enter your personal and professional information.</p>
                ...
                <h3 className="text-xl font-bold text-[#1E3A8A]">Choose Template</h3>
                <p className="text-gray-600">Select from our modern, professional templates.</p>
                <div className="absolute right-0 top-6 hidden h-0.5 w-full translate-x-1/2 bg-[#1E3A8A] lg:block"></div>
                </div>
                <div className="relative flex flex-col items-center space-y-4 text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1E3A8A] text-white">3</div>
                <h3 className="text-xl font-bold text-[#1E3A8A]">Preview & Tweak</h3>
                <p className="text-gray-600">Preview your document and make any necessary adjustments.</p>
                <div className="absolute right-0 top-6 hidden h-0.5 w-full translate-x-1/2 bg-[#1E3A8A] lg:block"></div>
                </div>
                <div className="flex flex-col items-center space-y-4 text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1E3A8A] text-white">4</div>
                <h3 className="text-xl font-bold text-[#1E3A8A]">Save & Download</h3>
                <p className="text-gray-600">Save your progress and download your finished documents.</p>
                </div>
            </div>
            </div>
        </section>
