...
const PDFViewer: React.FC<PDFViewerProps> = ({
  ...
  if (!file) {
    return (
      <div className="pdf-viewer flex items-center justify-center min-h-[70vh] bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 pt-2.5 dark:bg-gray-800">
